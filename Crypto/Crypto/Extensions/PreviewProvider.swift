...
class DeveloperPreview {
    ...
    let homeVieModel = HomeViewViewModel()
    
    let stat = Statistic(title: "Market Cap", value: "$32.894Bn",percentage: 32.73)
    let stat2 = Statistic(title: "Total Volume", value: "$1.345Tr")
    let stat3 = Statistic(title: "Portfolio Value", value: "$56.7K", percentage: -31.9)
